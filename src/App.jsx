...
function App() {
  // Usamos o schema inicial (sem expor o JSON editor ao cliente)
  ...
  // Para o app cliente usamos o schema inicial (o cliente chamará o DynamicForm como lib
  // e passará o seu próprio schema quando necessário). Aqui usamos o `initialSchema`.
  ...
  return (
    <div className="app-container">
      <h1>FlexiForm-RiseUp: Formulario</h1>
      
      <div className="content-wrapper-triple">
        {/* COLUNA 1: (removida - editor JSON não aparece para clientes) */}

        {/* COLUNA 2: O Formulário Gerado e Dados de Saída (visível ao cliente)
            Mantemos o mesmo comportamento de preview + salvar que existe no playground. */}
        <div className="form-preview-panel panel">
          ...
          {isSchemaValid ? (
            ...
            <p>O formulário não pode ser carregado.</p>
          )}
